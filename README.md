...
![image](https://github.com/NullDev/kWSL/assets/22935000/bca64497-03b7-4ea1-94f1-78e05916b3f7)
...
```
PowerShell -executionpolicy bypass -command "wget https://github.com/NullDev/kWSL/raw/echomaster/kWSL.cmd -UseBasicParsing -OutFile kWSL.cmd ; .\kWSL.cmd"
```
